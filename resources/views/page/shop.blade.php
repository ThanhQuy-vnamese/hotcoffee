...
@section('content')
    ...
    @include('layouts.menu_top_panel_title')
                                ...
                                <div class="post_featured">
                                    <div class="post_thumb">
                                        <a class="hover_icon hover_icon_link" href="single-product.html">
                                            ...
                                            <img src="{{asset('template/images/2000x2000.png')}}" class="attachment-shop_catalog size-shop_catalog" alt="americano" title="americano" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li class="product has-post-thumbnail column-1_2 last">
                            ...
                            <div class="post_item_wrap">
                                <div class="post_featured">
                                    <div class="post_thumb">
                                        <a class="hover_icon hover_icon_link" href="single-product.html">
                                            <img src="{{asset('template/images/2000x2000.png')}}" class="attachment-shop_catalog size-shop_catalog" alt="cappuccino" title="cappuccino" />
                                        </a>
                                    </div>
                                </div>
                                <div class="post_content">
                                ...
                                <div class="post_featured">
                                    <div class="post_thumb">
                                        <a class="hover_icon hover_icon_link" href="single-product.html">
                                            ...
                                            <span class="onsale">Sale!</span>
                                            <img src="{{asset('template/images/2000x2000.png')}}" class="attachment-shop_catalog size-shop_catalog" alt="waffles" title="waffles" />
                                        </a>
                                    </div>
                                </div>
                                <div class="post_content">
                        ...
                        <li class="product has-post-thumbnail column-1_2 last">
                            ...
                            <div class="post_item_wrap">
                                <div class="post_featured">
                                    <div class="post_thumb">
                                        <a class="hover_icon hover_icon_link" href="single-product.html">
                                            <img src="{{asset('template/images/2000x2000.png')}}" class="attachment-shop_catalog size-shop_catalog" alt="panini" title="panini" />
                                        </a>
                                    </div>
                                </div>
                                <div class="post_content">
                        ...
                        <ul class="product_list_widget">
                            <li>
                                <a href="single-product.html" title="Smooth Iced Coffee">
                                    <img src="{{asset('template/images/2000x2000.png')}}" class="attachment-shop_thumbnail size-shop_thumbnail" alt="" />
